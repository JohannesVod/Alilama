...
model_name = "alilama_batches_512"
...
# Training Parameters
BATCH_SIZE = 512
learning_rate = 5e-4*8 # set to 1e-4 at start, then at 1e-5
print(learning_rate)
...
# Logging:
log_interval = 4 # interval where we print the loss function
eval_interval = 8 # interval where we evaluate the model
eval_batches = 1