...
class TBlock(nn.Module):
    def __init__(self, device, params: ModelParams):
...
class Transformer(nn.Module):
    ...
    def __init__(self, token_count, device, params: ModelParams):
        ...
        self.blocks = nn.ModuleList([TBlock(device, params) for _ in range(params.blocks)])
        # final projection:
